...
const MarketView: React.FC<MarketViewProps> = ({ marketplaceAddr }) => {
  ...
  const handleFetchNfts = async (selectedRarity: number | undefined) => {
    try {
      const response = await client.getAccountResource(
        marketplaceAddr,
        '0x73bffe1bc729aac927c95624887f9b67cc363d8951a2aebea3db9bd861583564::NFTMarketplaceV3::Marketplace',
      );
  ...
  const handleConfirmPurchase = async () => {
    ...
    try {
      const priceInOctas = Math.round(selectedNft.price * 100000000);
